...
//            PlayerPrefs.Save();
//            Debug.Log($"Resetando di�logo '{dialogueID}' para teste.");
//        }

//        //if (PlayerPrefs.GetInt(playerPrefKey, 0) == 1)
//        //{
//        //    Debug.Log($"Di�logo inicial '{dialogueID}' j� foi mostrado. Destruindo script.");
//        //    Destroy(NPC); 
//        //    return;
//        //}
...
//        {
//            Debug.LogError($"InitialDialogueStarter: Refer�ncias faltando em {gameObject.name}!");
//            Destroy(NPC);
//            return;
//        }
...
//        Debug.Log($"Di�logo inicial '{dialogueID}' finalizado! Destruindo script.");
...
//    void OnDestroy()
//    {
//        // Se o di�logo ainda estiver ativo quando o script for destru�do, fecha
